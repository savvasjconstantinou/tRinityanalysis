...
#read in data
TpNS<- fread("C:/Users/Savvas Constantinou/Downloads/TpNS.csv", stringsAsFactors = F)
...
ticks<-c(-1:18)
ticksy<-seq(0, 18, 2)
axis(1, at=ticks, labels=ticks, lwd=2, pos=0, cex.axis=0.5)
axis(2, at=ticksy, labels=ticksy, lwd=2, pos=-0.8)
